...
const CHECKS = [
  ...
  { rpc: "set_financial_ai_conversation_visibility", migration: "00186", body: { p_conversation_id: ZERO_UUID, p_visibility: "private" } },
  {
    rpc: "create_ai_journal_entry_draft",
    migration: "00186",
    body: {
      p_org_id: ZERO_UUID,
      p_date: "2026-01-15",
...
const RPC_MIGRATION_FILE = {
  ...
  set_financial_ai_conversation_visibility: "20260618000186_efm_ai_assistant_l6.sql",
  create_ai_journal_entry_draft: "20260618000186_efm_ai_assistant_l6.sql",
  ...
  list_financial_ai_conversations: "20260618000186_efm_ai_assistant_l6.sql",
  create_financial_ai_conversation: "20260618000186_efm_ai_assistant_l6.sql",
  get_financial_ai_conversation: "20260618000186_efm_ai_assistant_l6.sql",
  append_financial_ai_message: "20260618000186_efm_ai_assistant_l6.sql",
  delete_financial_ai_conversation: "20260618000186_efm_ai_assistant_l6.sql",
