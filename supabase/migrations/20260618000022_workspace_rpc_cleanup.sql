-- Idempotent cleanup: ensure a single get_my_workspace / get_my_app_permissions signature (UUID with DEFAULT NULL).
-- Safe to run even if 00021 was partially applied.
...
-- Ensure list_my_workspaces exists (from migration 00021).
