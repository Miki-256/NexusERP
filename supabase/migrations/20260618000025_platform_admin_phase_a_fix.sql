-- Complete idempotent Phase A migration — run THIS file only in Supabase SQL Editor.
-- Safe even if 00024 failed partway (creates enum, tables, functions in correct order).
...
-- Role helpers MUST exist before the RLS policy below.
