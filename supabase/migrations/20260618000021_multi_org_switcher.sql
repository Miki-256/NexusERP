-- Multi-organization: list workspaces and resolve active org for permissions.
-- Drop zero-arg overloads from migration 00020 before adding the UUID parameter.
