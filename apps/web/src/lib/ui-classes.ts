...
/** Default dense page vertical rhythm (Wave 1A — less scroll to content). */
export const PAGE_SHELL = "space-y-2 sm:space-y-3";
...
/** Shell content padding (pair with pb-mobile-nav on main). Uses density tokens. */
export const CONTENT_PAD =
  "px-3 pt-2 sm:px-4 sm:pt-3 lg:px-5 lg:pt-3";

/** Mobile-first 2-col KPI / StatCard strip (avoid single-column stacking). */
export const KPI_GRID = "grid grid-cols-2 gap-2 sm:gap-3";
export const KPI_GRID_3 = "grid grid-cols-2 gap-2 sm:grid-cols-3 sm:gap-3";
export const KPI_GRID_4 = "grid grid-cols-2 gap-2 sm:gap-3 xl:grid-cols-4";
