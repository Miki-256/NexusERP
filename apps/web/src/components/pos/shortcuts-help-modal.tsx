...
const SHORTCUT_KEYS = [
  { key: "F2", labelKey: "shortcutFocusSearch" },
  { key: "F3", labelKey: "shortcutHold" },
  { key: "F4", labelKey: "shortcutRecall" },
  { key: "F5", labelKey: "shortcutFindCustomer" },
  { key: "F6", labelKey: "shortcutCloseShift" },
  { key: "F7", labelKey: "shortcutVoidRefund" },
  { key: "F8", labelKey: "shortcutCheckout" },
  { key: "F9", labelKey: "shortcutCameraScan" },
  { key: "Esc", labelKey: "shortcutCloseModal" },
] as const;
      ...
      >
        <div className="mb-4 flex items-center justify-between">
          ...
          <button
            ...
            aria-label={t("closeKeyboardShortcuts")}
          >
