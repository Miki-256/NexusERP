...
export default async function InvoicingPage() {
  ...
  const [{ data: invoices }, { data: creditNotes }, { data: customers }, { data: taxCodesData }] = await Promise.all([
    supabase
      .from("customer_invoices")
      .select("id, invoice_no, invoice_date, due_date, status, subtotal, tax_amount, total, customer_id, customers(name)")
